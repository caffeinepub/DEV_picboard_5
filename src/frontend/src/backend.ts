...
export interface backendInterface {
    __images(ko: ImageId | null, count: bigint | null): Promise<Array<[ImageId, ImageEntry]>>;
    __state(): Promise<any>;
    listImages(): Promise<Array<ImageEntry>>;
    uploadImage(data: Uint8Array): Promise<ImageId>;
}
import type { ImageId as _ImageId } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async __images(arg0: ImageId | null, arg1: bigint | null): Promise<Array<[ImageId, ImageEntry]>> {
        if (this.processError) {
            try {
                const result = await this.actor.__images(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n2(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async listImages(): Promise<Array<ImageEntry>> {
        if (this.processError) {
            try {
    ...
    async uploadImage(arg0: Uint8Array): Promise<ImageId> {
        if (this.processError) {
            try {
